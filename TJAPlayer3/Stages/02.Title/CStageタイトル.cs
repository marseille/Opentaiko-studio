	...
	internal class CStageタイトル : CStage
	{
		...
		public override int On進行描画()
		{
			if (!base.b活性化してない)
			{
				...
				string strCreator = "https://github.com/marseille/Opentaiko-studio";
				AssemblyName asmApp = Assembly.GetExecutingAssembly().GetName();
				TJAPlayer3.act文字コンソール.tPrint(4, 44, C文字コンソール.Eフォント種別.白, "DEBUG BUILD");
				TJAPlayer3.act文字コンソール.tPrint(4, 4, C文字コンソール.Eフォント種別.白, "OpenTaiko-Studio" + " Ver." + TJAPlayer3.VERSION + " (" + strCreator + ")");
